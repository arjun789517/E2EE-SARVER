...
This is a multi-user Python automation application created by **Arjun Thakur** that uses Selenium WebDriver to perform browser-based **Facebook Group Name & Nickname Lock System**. The application features a beautiful web interface with secure user authentication and individual user configurations.
